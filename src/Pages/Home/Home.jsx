...
import two from "../../Assets/man1.jpg";
        ...
        <Container>
          <Row>
            <Col xs={12} className="text-center">
              <motion.h1
                className="title fs-1 mb-4 mb-md-5"
                initial={{ x: -900 }}
                animate={{ x: 0 }}
                viewport={{ once: true }}
                transition={{
              ...
              <motion.button
                className="mainBtn ps-5 pe-5 p-3 text-capitalize"
                initial={{ y: -500 }}
                animate={{ y: 0 }}
                viewport={{ once: true }}
                transition={{
              ...
              <Col xs={12} lg={6} className="mb-5 mb-lg-0">
                <div className="d-flex flex-column">
                  ...
                  >
                    ...
                    Facere in enim atque. Velit dolor incidunt impedit
                    doloremque provident pra sunt tenetur cupiditate nihil
                    veniam nostrum obcae.
                  </motion.p>
                  <motion.div
          ...
          <section className="third pt-5 mt-5">
            <div className="text-center mb-5">
              ...
              <motion.button
                className="mainBtn p-2 ps-4 pe-4"
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                viewport={{ once: true }}
          ...
          <section className="four pt-4 pt-lg-5 mt-5">
            ...
            <Col lg={9} className="mb-3">
              ...
              >
                ...
                nemo provident nam aspernatur quaerat perspiciatis amet illo
                nesciunt asperiores cupiditate ipsam officiis architecto ullam
                nobis commodi, iste aut consectetur animi Lorem ipsum dolor sit
                amet consectetur adipisicing elit. Minus nemo provident nam
                aspernatur quaerat perspiciatis amet illo nesciunt asperiores
                cupiditate ipsam officiis architecto ullam nobis commodi, iste
                aut consectetur animi
              </motion.q>
            </Col>

            <motion.span
              className="fs-5 fw-bold d-flex justify-content-center justify-content-md-start"
              initial={{ opacity: 0 }}
